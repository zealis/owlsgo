...
<section class="panel">
    ...
    <div class="panel__body">
        <div class="hstack" style="align-items:flex-start;gap:16px;flex-wrap:wrap">
            ...
            <div style="min-width:0;flex:1 1 260px">
                <div class="hstack" style="gap:8px;flex-wrap:wrap">
                    ...
                    <span class="badge outline" style="color:<?= e($groupColor) ?>">
                ...
                <dl class="kv" style="margin-top:12px">
                    ...
                    <dd>
                        <?php if ($createdAt > 0): ?>
                            ...
                            <span class="text-light">（<?= e(human_time($createdAt)) ?>）</span>
                        <?php else: ?>
                            —
                        <?php endif; ?>
                    </dd>
                    ...
                    <dd>
                        ...
                        <span class="text-light mono"><?= e((string)($profile['last_login_ip'] ?? '')) ?></span>
                    </dd>
                </dl>
            </div>
...
<section class="panel">
    ...
    <div class="panel__body">
        ...
        <?php elseif ($isSuper): ?>
            <div role="alert" data-variant="warning" style="margin-bottom:14px">
            ...
            <div class="form-grid">
                <div data-field>
                    ...
                    <?php if ($isSelf): ?>
                        ...
                        <span data-hint>不能修改自己的用户组。</span>
                    <?php endif; ?>
...
<?php if ($canBan): ?>
    <section class="panel">
        <div class="panel__head">
            ...
            <span class="spacer"></span>
            <?php if ($ban !== null): ?>
                <span class="badge" data-variant="<?= $banExpired ? 'warning' : 'danger' ?>">
                    <?= $banExpired ? '存在已过期的封禁' : '封禁生效中' ?>
                </span>
            <?php else: ?>
                <span class="badge outline">未封禁</span>
            <?php endif; ?>
        </div>
            ...
            <?php else: ?>
                ...
                <?php if ($ban !== null): ?>
                    <dl class="kv" style="margin-bottom:14px">
                        ...
                        <dd>
                            <?php if ($expiresAt === 0): ?>
                                <span class="badge" data-variant="danger">永久封禁</span>
                            <?php else: ?>
                                <?= e(date('Y-m-d H:i', $expiresAt)) ?>
                                <?php if ($banExpired): ?>
                                    <span class="text-light">（已过期，实际已可登录）</span>
                                <?php endif; ?>
                            <?php endif; ?>
                        </dd>
                    ...
                    <form method="post" action="<?= e(url('/admin/users/' . $userId . '/unban')) ?>"
                        ...
                        <span class="text-light" style="font-size:12.5px;margin-left:8px">
                ...
                <?php else: ?>
                    ...
                    <?php if (old_error('ban') !== ''): ?>
                        <div role="alert" data-variant="danger" style="margin-bottom:14px">
                            <?= $view('partials/icon', ['name' => 'alert', 'size' => 18]) ?>
                    ...
                    <form method="post" action="<?= e(url('/admin/users/' . $userId . '/ban')) ?>"
                        ...
                        <div class="form-grid">
                            ...
                            <div data-field>
                                ...
                                <span data-hint>填 0 表示永久封禁。</span>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="button" data-variant="danger">
